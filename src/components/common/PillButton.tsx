...
export const PillButton = ({ children, primaryColor, ...attributes }: PillButtonProps) => {
  return (
    <button
      className={`${
        primaryColor ? 'before:bg-primary' : 'before:bg-primary/10 dark:before:border-gray-700 dark:before:bg-gray-800'
    ...
    >
      <span
        className={`relative text-base font-semibold ${primaryColor ? 'text-white' : 'text-primary dark:text-white'}`}
      >
        {children}
      </span>
    </button>
