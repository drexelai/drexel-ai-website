        ...
        <Container>
          <div className="space-y-8">
            <div className="mt-8 space-y-2 text-center">
              ...
              <ul>
              <li>
                <h3 className="font-bold text-md lg:text-lg dark:text-gray-100 pb-4"><a href="https://www.sciencedirect.com/science/article/pii/S2667318522000150">Recent advances and application of generative adversarial networks in drug discovery, development, and targeting</a></h3>
                ...
                <li>
                <h3 className="font-bold text-md lg:text-lg dark:text-gray-100 pb-4"><a href="https://www.sciencedirect.com/science/article/pii/S235291482200199X">RadGenNets: Deep learning-based radiogenomics model for gene mutation prediction in lung cancer</a></h3>
                <p className="lg:mx-auto text-sm lg:text-md lg:w-6/12 text-gray-600 dark:text-gray-200">
              ...
              <br/>
              <li>
                <h3 className="font-bold text-md lg:text-lg dark:text-gray-100 pb-4"><a href="https://ieeexplore.ieee.org/abstract/document/9533483">Towards Searching Efficient and Accurate Neural Network Architectures in Binary Classification Problems</a></h3>
                <p className="lg:mx-auto text-sm lg:text-md lg:w-6/12 text-gray-600 dark:text-gray-200">
              ...
              <br/>
              <li>
                <h3 className="font-bold text-md lg:text-lg dark:text-gray-100 pb-4"><a href="https://arxiv.org/abs/2103.01121">Extreme volatility prediction in stock market: When gamestop meets long short-term memory networks</a></h3>
                <p className="lg:mx-auto text-sm lg:text-md lg:w-6/12 text-gray-600 dark:text-gray-200">
